    ...
    <div>
        ...
        <div class="search-input">
            ...
            <!--
                ...
                按上下键可以选择列表条目
            -->
            <input placeholder="商品名称或关键字" type="text" v-model="keyword" @keyup="get($event)" @keydown.enter="search()" @keydown.down="selectDown()" @keydown.up.prevent="selectUp()">
            <!-- 这是一个小叉叉，点击它可清除输入框内容 -->
...
import { completion } from '/api/index'
export default {
    data(){
        return {
    ...
    methods: {
        ...
        get: function(ev) {
            ...
            let _this=this;
            completion({word:this.keyword,encodein:"utf-8",encodeout:"utf-8"},
                function(error,res) {
                    if(error){
                        _this.myData =[];
                    }else{
