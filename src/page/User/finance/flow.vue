  ...
  export default {
    data () {
      return {
        orderList: [],
        forms:[
            {"name":"Input",label:"交易流水号","model":"shopName",placeholder:"商品名称"},
             {"name":"Select",label:"交易类型","model":"orderNO",placeholder:"订单编号"},
             {"name":"Input",label:"订单编号","model":"orderNO",placeholder:"订单编号"},
             {"name":"Select",label:"订单状态","addresState":"Kist",placeholder:"订单状态"},
            {"name":"DatePicker",label:"交易时间","model":"times",type:"daterange",placeholder:"请选择日期" },
